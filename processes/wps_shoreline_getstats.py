...
# execute https://shoreline-monitor.avi.directory.intra/wps?service=wps&request=Execute&version=2.0.0&Identifier=wps_shoreline_getstats&datainputs=profileid={"profileid":2805066}
...
from .shoreline_getstats import handler
import logging
logger = logging.getLogger("PYWPS")

class WpsShorelineGetStats(Process):
    def __init__(self):
        ...
        super(WpsShorelineGetStats, self).__init__(
            self._handler,
            identifier="wps_shoreline_getstats",
            version="1.0.0",
            title="Retrieve shoreline statistics",
            abstract='The process provides detailed statistics about the change rate of shorelines for a 5 km radius around a profile. The source' \
